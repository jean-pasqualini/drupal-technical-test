        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    '/home/darkilliant/project/interview/charles-river/jean-pasqualini/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl'
                );
            } else {
                $template = new Template(
                    '/home/darkilliant/project/interview/charles-river/jean-pasqualini/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl'
                );
            }
